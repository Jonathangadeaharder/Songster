		...
		if (
			stryMutAct_9fa48('2192')
				...
				: stryMutAct_9fa48('2191')
					...
					: stryMutAct_9fa48('2190')
						? session
						: (stryCov_9fa48('2190', '2191', '2192'), !session)
		) {
			if (stryMutAct_9fa48('2193')) {
				...
				const redirectTo = encodeURIComponent(
					stryMutAct_9fa48('2194') ? `` : (stryCov_9fa48('2194'), `/results/${params.code}`)
				);
				throw redirect(
					303,
					stryMutAct_9fa48('2195')
						? ``
						: (stryCov_9fa48('2195'), `/auth/login?redirectTo=${redirectTo}`)
				);
			}
		}
		return stryMutAct_9fa48('2196')
			? {}
			: (stryCov_9fa48('2196'),
				{
					code: params.code,
